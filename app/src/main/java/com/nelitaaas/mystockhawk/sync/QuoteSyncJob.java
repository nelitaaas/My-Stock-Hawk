package com.nelitaaas.mystockhawk.sync;
...
public final class QuoteSyncJob {
    ...
    private static final String ACTION_DATA_UPDATED = "com.nelitaaas.mystockhawk.ACTION_DATA_UPDATED";
    ...
    static HttpUrl createQuery(String symbol) {
        ...
        httpUrl.addQueryParameter("column_index", "4")  //closing price
                ...
                .addQueryParameter("api_key", "AVazPbhNyqH4xebyqUke");
