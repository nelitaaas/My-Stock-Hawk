    ...
    public void onBindViewHolder(StockViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                cursor.moveToPosition(position);
                Intent stockDetails = new Intent(context, StockDetailsActivity.class);
                stockDetails.putExtra(StockDetailsActivity.EXTRA_STOCK, cursor.getString(Contract.Quote.POSITION_SYMBOL));
                context.startActivity(stockDetails);
            }
        });
    }
